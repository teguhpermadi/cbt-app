    ...
    public function updatedSelectedDifficulty(): void
    {
        if ($this->selectedDifficulty) {
            try {
                ...
                $this->dispatch('notify', message: 'Tingkat kesulitan berhasil diperbarui', type: 'success');
                
            } catch (\Exception $e) {
                // Add error notification
                $this->dispatch('notify', message: 'Gagal memperbarui tingkat kesulitan', type: 'error');
