...
class MultipleSelectionEditorComponent extends Component
{
    use WithFileUploads;
                ...
                if (isset($optionData['new_media'])) {
                    ...
                    if ($file instanceof \Illuminate\Http\UploadedFile && $file->isValid()) {
                        try {
                            ...
                            // Clear the new_media from the array
    ...
    {
        return view('livewire.question.form.option.multiple-selection-editor-component');
    }
}
