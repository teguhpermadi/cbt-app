...
<ul class="w-full space-y-2">
    ...
    <li @class([ 'flex items-center justify-between p-2 rounded-lg border' , 'bg-white dark:bg-zinc-900 border-zinc-100 dark:border-zinc-800'=> !$isKey,
        'bg-white/50 dark:bg-zinc-900/50 border-success/20 text-zinc-900 dark:text-zinc-100' => $isKey,
        ])>
        <span class="text-zinc-500 shrink-0">{{ $left }}</span>
