<div class="space-y-4">
    <div class="grid grid-cols-2 gap-4 text-sm bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
        <div>
        ...
        <div>
            ...
            <div class="font-bold text-gray-900 dark:text-white">{{ $record->total_score }}</div>
        </div>
        <div>
    ...
    <div class="space-y-6">
        ...
        <div class="{{ $borderClass }} p-4 rounded-r-lg shadow-sm border border-gray-100 dark:border-gray-800">
            ...
            <div class="prose dark:prose-invert max-w-none text-sm mb-4">
                {!! $question->content !!}
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 pt-4 border-t border-gray-100 dark:border-gray-800">
                ...
                <div class="text-sm">
                    ...
                    <div class="p-3 bg-success-50/50 dark:bg-success-950/10 rounded-lg border border-success-200 dark:border-success-800/50 min-h-[50px]">
                        @php
